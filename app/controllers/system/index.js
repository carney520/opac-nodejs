...
exports.before = [
  ...
  function(req,res,next){
    passport._viewHelper('super',
        req.url_for('system_login'),req.url_for('main_logout'))(
        req,res,next);
  },
...
exports.login = function(req,res,next){
  ...
  if(req.user && req.user.role === 'super'){
    ...
    res.render('login',
        {role:'super',action_path:req.url_for('system_login')});
  }
};
...
exports.authentication = function(req,res,next){
  passport._authentication(
        req.url_for('system'),req.url_for('system_login')
        )(req,res,next);
};
