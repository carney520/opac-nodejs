    ...
    if (req.user) {
      ...
      switch (role) {
        case 'reader':
          locals.navs.push({
            name: '个人中心',
            url: req.url_for('user', req.user.card_no),
          })
          break
        case 'admin':
...
exports.logout = function(req, res, next) {
  passport._logout(req.url_for('main'))(req, res, next)
}

exports.authentication = function(req, res, next) {
  var redirectUrl = req.body.redirect_to || req.url_for('main')
  passport._authentication(redirectUrl, req.url_for('main_login'))(
    req,
    res,
    next
  )
